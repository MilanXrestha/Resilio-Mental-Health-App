...
class _MoodCalendarScreenState extends State<MoodCalendarScreen> with SingleTickerProviderStateMixin {
  ...
  void _showEditNoteDialog(MoodEntryModel entry) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        backgroundColor: isDarkMode ? Theme.of(context).colorScheme.surface : Theme.of(context).colorScheme.surface,
        title: Text(
          'Edit Note',
          style: TextStyle(
            fontFamily: 'Poppins',
        ...
        content: TextField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: TextStyle(
              fontFamily: 'Poppins',
              fontSize: 14.sp,
              color: isDarkMode ? Theme.of(context).colorScheme.onSurface.withOpacity(0.5) : Theme.of(context).colorScheme.onSurface.withOpacity(0.5),
            ),
            filled: true,
  ...
  Widget _buildMoodDayInfo(MoodEntryModel entry, bool isDarkMode) {
    ...
    final formattedTime = DateFormat.jm().format(entry.createdAt);
