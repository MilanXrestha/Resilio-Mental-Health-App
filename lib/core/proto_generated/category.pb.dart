...
class Category extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'resilio.category'),
...
class CategoryServiceApi {
  ...
  /// Get all categories
  $async.Future<ListCategoriesResponse> getCategories(
          $pb.ClientContext? ctx, $0.Empty request) =>
      _client.invoke<ListCategoriesResponse>(ctx, 'CategoryService',
          'GetCategories', request, ListCategoriesResponse());

  /// Get category by ID
  $async.Future<Category> getCategory(
          $pb.ClientContext? ctx, GetCategoryRequest request) =>
      _client.invoke<Category>(
          ctx, 'CategoryService', 'GetCategory', request, Category());
}
